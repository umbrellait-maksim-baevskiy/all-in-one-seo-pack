				...
				<div class="aioseop_metabox_text">
					<ul>
						<li>
							...
							href="
							<?php
							echo aioseop_add_url_utm(
								'https://semperplugins.com/documentation/',
								array(
									'utm_campaign' => 'support-box',
						...
						<li>
							...
							<?php
							echo aioseop_add_url_utm(
								'https://semperplugins.com/support/',
								array(
									'utm_campaign' => 'support-box',
									'utm_content'  => 'support',
								)
							...
							?>
									"><?php _e( 'Access our Premium Support', 'all-in-one-seo-pack' ); ?></a>
						</li>
						<li>
						...
						<li>
							...
							<?php
							echo aioseop_add_url_utm(
								'https://semperplugins.com/doc-type/video/',
								array(
									'utm_campaign' => 'support-box',
									'utm_content'  => 'video',
								)
							...
							?>
									"><?php _e( 'Watch video tutorials', 'all-in-one-seo-pack' ); ?></a>
						</li>
						<li>
							...
							echo aioseop_add_url_utm(
								...
								array(
									'utm_campaign' => 'support-box',
									'utm_content'  => 'quick-start',
								)
							);
							?>
									"><?php _e( 'Getting started? Read the Beginners Guide', 'all-in-one-seo-pack' ); ?></a>
						</li>
					</ul>
				</div>
				<?php break; ?>
