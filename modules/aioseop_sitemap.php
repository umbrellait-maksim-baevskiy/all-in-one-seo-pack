...
if ( ! class_exists( 'All_in_One_SEO_Pack_Sitemap' ) ) {
	...
	class All_in_One_SEO_Pack_Sitemap extends All_in_One_SEO_Pack_Module {
		...
		public function get_sitemap_data( $sitemap_type, $page_number = 0 ) {
			...
			switch ( $sitemap_type ) {
				...
				default: {
					...
					} elseif ( is_array( $this->extra_sitemaps ) && in_array( $sitemap_type, $this->extra_sitemaps ) ) {
		...
		protected function output_rss( $urls, $sitemap_type, $comment ) {
			...
			if ( is_multisite() ) {
				// TODO Add esc_* function.
				echo '<title>' . aiosp_common::esc_xml( 'title', get_blog_option( get_current_blog_id(), 'blogname' ) ) . '</title>' .
				...
				// TODO Add esc_* function.
				echo '<title>' . aiosp_common::esc_xml( 'title', get_option( 'blogname' ) ) . '</title>' .
