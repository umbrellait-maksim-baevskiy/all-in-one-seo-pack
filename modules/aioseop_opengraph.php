	...
	class All_in_One_SEO_Pack_Opengraph extends All_in_One_SEO_Pack_Module {
		...
		function __construct() {
			...
			$this->help_text = Array(
				...
				"generate_descriptions"  => __( "This option will auto generate your Open Graph descriptions from your post content instead of your post excerpt. This is useful if you don't use use post excerpts but want descriptions pulled from the content instead. WooCommerce users should read the documentation regarding this setting.", 'all-in-one-seo-pack' ),
...
END;
		...
		function do_opengraph() {
			...
			if ( ! defined( 'DOING_AJAX' ) ) {
				...
				add_action( 'amp_post_template_head', Array( $this, 'add_meta' ), 5 ); // Add social meta to AMP plugin.
			}
		}
